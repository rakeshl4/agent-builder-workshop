...
2. Explain typical timeline (5-7 business days)
3. List required documents
4. Suggest applying early to allow buffer time
...
1. Proactively ask if the traveler has checked visa requirements
2. For common destinations (Japan, Canada, USA, Schengen), mention that requirements exist
3. Offer to check specific requirements if nationality is known
4. Remind about processing times to ensure timely travel planning
